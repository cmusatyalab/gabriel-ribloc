...
_RIBLOC = _descriptor.Descriptor(
  name='Ribloc',
  full_name='instruction.Ribloc',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='gauge_color', full_name='instruction.Ribloc.gauge_color', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='clear_color', full_name='instruction.Ribloc.clear_color', index=1,
...
_ENGINEFIELDS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ribloc', full_name='instruction.EngineFields.ribloc', index=4,
...
_ENGINEFIELDS.fields_by_name['ribloc'].message_type = _RIBLOC
...
_ENGINEFIELDS.oneofs_by_name['state'].fields.append(
  _ENGINEFIELDS.fields_by_name['ribloc'])
_ENGINEFIELDS.fields_by_name['ribloc'].containing_oneof = _ENGINEFIELDS.oneofs_by_name['state']
DESCRIPTOR.message_types_by_name['Ribloc'] = _RIBLOC
...
Ribloc = _reflection.GeneratedProtocolMessageType('Ribloc', (_message.Message,), dict(
  DESCRIPTOR = _RIBLOC,
  __module__ = 'instruction_pb2'
  # @@protoc_insertion_point(class_scope:instruction.Ribloc)
  ))
_sym_db.RegisterMessage(Ribloc)
